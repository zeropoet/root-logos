...
source, grammar, witness, and identity lineage. Maintenance
...
- `assets/library-first-frames/` holds canonical 2400×2400 PNG portraits for
  ...
  Library order, sealed edition, renderer, dimensions, and SHA-256. Once
  admitted, that portrait is never regenerated by later Library growth; a new
  reading grammar creates a separately witnessed image in the visual lineage.
...
SVG first frames. The Library now holds 56 coherent objects and composes them
through 170 witnessed cross-work relations.
...
are comparable only among v4 successor editions. `170` is independently the
count of cross-work relations in the current 56-object Library composition.
...
Those admitted work structures now remain fixed. Above them, 170 pair-relations
...
The public Library surface is intentionally limited to the stable list of
coherent works, the selected work or composition description, its navigable
