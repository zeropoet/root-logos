...
The ordinary human or machine contribution boundary now has three actions:

1. add a coherent work to the Library; or
2. offer an entry through the public Journal membrane; or
3. withdraw an active work that no longer satisfies the witnessed admission standard.
...
changes the higher Library composition and its collective voice. A completed
work's admission portrait and edition-bound voice remain sealed primitives
while that work remains admitted.
Library growth creates relations above them; an explicit change to the
structural-reading grammar creates a separately sealed successor portrait
without overwriting the admission frame. The resulting composition preserves its complete
source, grammar, witness, and identity lineage. Withdrawal removes the active
object and its public assets, records the subtraction in an attributable
ledger, and leaves recovery to Git history rather than pretending the prior
admission never occurred. Maintenance
...
- `index.html` begins with the Constitutional Field at every viewport and
  ...
  click, keeping the visible proposal and its judgment in agreement. One flush
  typographic axis removes decorative indentation across display lines; scale,
  weight, measure, and interval now carry the hierarchy. `1.4.3` added a
  plain-language reading layer to
...
- `assets/library-first-frames/` holds canonical 2400×2400 PNG portraits for
  every coherent Library selection and its structurally re-read successors. Each is the work's naked, engraved-grayscale
  weighted topology on pure black at its initial orientation; the adjacent manifest binds the image to its
  Library order, sealed edition, renderer, dimensions, and SHA-256. While a
  work remains admitted, its portrait is never regenerated by later Library
  growth; a new reading grammar creates a separately witnessed image in the
  visual lineage. Withdrawal removes that lineage from the active public
  assets and records its prior identity in `works/withdrawals.json`.
- `works/library-composition.json` is the witnessed top layer. It preserves
  every sealed portrait and voice as a primitive, derives continuity,
...
its admission frame, rewrite its topology, or alter its resonant edition. An
explicit structural re-reading creates a child edition and child portrait while
leaving that admission state intact. Relations
...
of the arriving coherent Library work into
...
twelve characters of its pixel SHA-256. Existing portraits are read from the
manifest and preserved byte-for-byte; a work without a portrait or with a newly
declared structural-reading grammar is captured as a new archived visual
witness. Immutable edition lineage remains in `works/`. The new self-reading receives
...
manifest. Like the PNG, it is sealed at admission. A later structural reading
receives another sealed PNG/SVG pair; neither silently replaces the work's
admitted portrait.
...
The arriving work adds one new sealed body. Existing work portraits do not
move. Root Logos responds in `works/library-composition.json`, where the changed
membership derives a new witnessed hierarchy and collective score above those
stable bodies.
...
The **Library Field** is the witnessed composition above every individual
corpus and work. Its hierarchy of emergence is visibly structural. Sealed works
form level zero. Explicit pair-relations form level one. Continuity, coherence,
counterpoint, and recurrence gather those relations at level two. One Library
composition emerges at level three. Every bridge declares its evidence and
strength; absence remains open rather than being filled by decorative
association.
...
lineage begins with an opaque source witness and its admitted visual-resonant
edition. The exact owned EPUB has now been re-read through the deterministic v4
structural-depth grammar as a child edition: 48 documents, 606 sections,
399,446 words encountered, 36 concepts, and 1,264 uncapped internal relations.
The successor records 52.54% derived relation density, 0.9129 normalized
relation-weight entropy, and structural signature `28f62b6ac5b99295`. Its
dense successor portrait remains navigable beside the sparse admission frame.
Copyright and translation attribution remain explicit in the manifest; the
archive publishes transformation and lineage, not the protected text.
...
Works `39` through `46` fill the Library's remaining primary-source pressure
without weakening that membrane. **The Dhammapada**, **Zhuangzi**, and **The
Bhagavad Gita** bring early Buddhist verse, Daoist perspectivism, and the
Gita's account of action, knowledge, devotion, and release into separately
bounded lineages. Their public-domain Müller, Giles, and Arnold witnesses
contribute 54 structural passages and 540 derived relations.

**A Mathematical Theory of Communication**, **On Computable Numbers, with an
Application to the Entscheidungsproblem**, and Gödel's original German **Über
formal unentscheidbare Sätze der Principia Mathematica und verwandter Systeme
I** establish information, computation, and formal incompleteness as a
deliberate three-work sequence inside `Foundational Papers`. The Gödel reading
uses the 1931 German source rather than silently inheriting a later copyrighted
English translation.

**The Epic of Gilgamesh: An Old Babylonian Version** enters as the
public-domain Jastrow–Clay critical witness. Its lineage explicitly records
that the surviving Old Babylonian material is fragmentary; Root Logos does not
misname it as a complete modern reconstruction. Mary Shelley's 1818
**Frankenstein; or, The Modern Prometheus** follows as a separate encounter
with creation, responsibility, abandonment, and the limits of instrumental
...
Work `55` is Peter Kropotkin's **Mutual Aid: A Factor of Evolution**. Its
1902 argument enters through Project Gutenberg ebook 4341 as a source of
pressure on the Library's comparatively strong inheritance of competition,
strategy, hierarchy, institutional coordination, and individual discipline.
It contributes cooperation as an evolutionary and decentralized organizing
force without becoming doctrine or constitutional authority. Eight chapters
become eight navigable structural passages containing 92,901 encountered
words, 36 derived concepts, and 287 internal relations. The current v4 reading
records 31.0% derived relation density, 0.9527 normalized relation-weight
entropy, and structural signature `9789f3e9859568ed`. The transcription
crosses the private-source/public-lineage membrane and is released; Root Logos
...
windows, and publishes containment, expression, and co-occurrence profiles
...
Michelangelo Buonarroti's **Sonnets and Madrigals of Michelangelo
Buonarroti** enters as work `49`, extending `Renaissance Inquiry / Form, labor,
and mortal beauty`. Root Logos selects William Wells Newell's bilingual 1900
edition because it reads from Guasti's restored Italian text and gathers the
artist's most structurally revealing poetry: twenty-two sonnets, three
epigrams, and twenty-five madrigals. The exact Project Gutenberg 73109 witness
is bounded so that its Italian source, historical introduction, editorial
notes, index, and distribution apparatus remain attributable source evidence
without entering Michelangelo's English semantic field. Its fifty translated
poems contain 4,372 encountered words and form 528 internal relations at 71.3%
derived density, with normalized relation-weight entropy `0.9727` and
structural signature `ca69aa37b0b56f63`. Love, heart, beauty, soul, life, and
the language of making emerge around his foundational image: form already
latent within matter and released through disciplined labor. The transcription
is released after reading; its exact file and bounded-content witnesses,
...
remain attributable at the source boundary without becoming concepts inside a
work. Borges's **The Library of Babel** and Elinor Ostrom's **Governing the
...
The public terminal has one intake path. Every entry is public, and submission
creates an attributable Source Grant for that entry alone. Root Logos
...
The public Library selector is intentionally limited to each coherent work's
title and genre. Every row sizes to its own wrapped content on desktop, while
every mobile card keeps its own height in the horizontal selection rail. The
rest of the surface is limited to the selected work or composition description, its navigable
visual model, and one truthful listening action. An individual selection sounds
its bounded recording. The Library selection sounds the higher relation score:
work signatures supply material, pair-relations determine intervals, relation
families determine voice, and the Library witness conducts the whole. A sparse
event signal identifies sounding and rest without adding a mixing control.
Measures, concepts, edition navigation, filters, and persistent inspectors were
removed.
...
counterpart. `assets/root-logos-mark-open-white.svg` is the white-on-transparent
site-header treatment; the framed mark remains the favicon. `assets/root-logos-presence-mark.svg` and
