...
work's first-frame portrait and edition-bound voice remain sealed primitives;
emergence happens through new relations above them rather than by regenerating
their individual forms. The resulting composition preserves its complete
...
- `assets/library-first-frames/` holds one canonical 2400×2400 PNG portrait for
  ...
  admitted, that portrait is never regenerated by later Library growth.
...
manifest and preserved byte-for-byte; only a work without a sealed portrait is
captured. Immutable edition lineage remains in `works/`. The new self-reading receives
...
manifest. Like the PNG, it is sealed at admission. A later edition may receive
lineage and compositional consequence, but it does not silently replace the
work's admitted portrait.
