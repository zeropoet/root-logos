...
assert.equal(telosWitness.system_mapping.operating_components.length, 7);
...
assert.equal(telosWitness.system_mapping.source_commit, "283632b");
...
assert.equal(validated.foldPortraitSnapshot.measures.reflection_cycles, 3);
assert.equal(validated.foldPortraitSnapshot.measures.reflection_pngs, 3);
assert.equal(validated.foldPortraitSnapshot.measures.prepared_unsigned_reflections, 3);
...
assert.equal(validated.foldPortraitSnapshot.current_reflection, "FP-REFLECT-0003");
