...
assert.equal(validated.sovereignStandardSnapshot.measures.witness_works, 54);
assert.equal(validated.sovereignStandardSnapshot.measures.vessel_work_relations, 14);
