...
for (const volume of catalog.volumes) {
  ...
  const manifestBase = {
    ...
    chapters: chapters.map((chapter) => ({ work_number: chapter.number, title: chapter.title, writing_witness: chapter.receipt.witnesses.writing, first_frame_witness: chapter.receipt.first_frame.sha256, geometry_witness: chapter.receipt.witnesses.geometry_v1, sound_witness: chapter.receipt.witnesses.sound_v1, living_object: `https://folio.rootlogos.com/?work=${chapter.number}` })),
