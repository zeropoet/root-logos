...
assert.equal(graph.meta.interfaceVersion, "1.4.8");
...
assert.equal(exports.at(-1).export_id, "RL-EXPORT-0018");
assert.equal(exports.at(-1).revision_entry.version, "1.4.8");
